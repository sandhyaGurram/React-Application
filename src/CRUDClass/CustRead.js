    ...
    render() {
        return (
            <div className="container p-5">
                <h1 className="text-center mb-5">Upcoming Batches</h1>
                        ...
                        {this.state.batches.map((bat) => {
                            return (
                                <tr key={bat.id}>
                                    ...
                                    <td>
                                        <button className=" me-3 p-1 btn btn-outline-success" data-bs-target="#update" data-bs-toggle="modal" onClick={()=>{this.editBatch(bat.id)}}><i className="bi bi-pencil-fill"></i></button>
                                        <button className="p-1 btn btn-outline-danger" onClick={() => { this.deleteBatch(bat.id) }}><i className="bi bi-trash-fill"></i></button>
                                    </td>
                                </tr>)
                        })}
                    </tbody>
